...
const MncAboutPage = () => {
  return (
    <Container>
      ...
      nisl ut ante blandit hendrerit. Aenean sit amet nisi. Atirei o pau no
      ...
      Per aumento de cachacis, eu reclamis. Nec orci ornare consequat. Praesent
      lacinia ultrices consectetur. Sed non ipsum felis.
    </Container>
  );
};

export default MncAboutPage;
